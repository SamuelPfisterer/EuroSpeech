"""
Supabase configuration and utility functions for the Serbian Parliament download system.
"""
...
def get_parliament_progress() -> Dict[str, Any]:
    """Get the current progress for the Serbian parliament."""
    client = get_supabase()
