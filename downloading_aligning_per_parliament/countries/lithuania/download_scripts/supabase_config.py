"""
Supabase configuration and utility functions for the Lithuanian Parliament download system.
"""
...
def get_parliament_progress() -> Dict[str, Any]:
    """Get the current progress for the Lithuanian parliament."""
    client = get_supabase()
